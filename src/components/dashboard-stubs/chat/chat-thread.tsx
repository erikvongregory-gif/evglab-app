      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <div className="flex flex-col gap-6 px-2 py-8">
          <Marker variant="separator">
            <MarkerContent>6. Mai 2026</MarkerContent>
          </Marker>
                ...
                <MessageContent>
                  <BubbleGroup>
                    <Bubble variant={isOutbound ? "default" : "muted"} align={message.align}>
                      ...
                      {message.reaction ? (
                        <BubbleReactions aria-label={`Reaktion: ${message.reaction}`} align={reactionAlign}>
      ...
      <div className="px-2">
        <Tabs defaultValue="reply" className="gap-0 rounded-md border">
          ...
          <TabsContent value="reply" className="m-0">
            <MessageComposer placeholder="Nachricht schreiben…" />
          </TabsContent>
          <TabsContent value="note" className="m-0">
            <MessageComposer placeholder="Interne Notiz schreiben…" />
          </TabsContent>
        </Tabs>
      </div>
    </div>
