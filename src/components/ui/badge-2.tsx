...
const badgeButtonVariants = cva(
  "inline-flex size-3.5 cursor-pointer items-center justify-center rounded-md p-0 leading-none opacity-60 transition-all -me-0.5 hover:opacity-100 [&>svg]:size-3.5 [&>svg]:!opacity-100",
  {
    variants: {
      variant: {
        default: "",
