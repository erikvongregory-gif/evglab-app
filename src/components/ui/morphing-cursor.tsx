...
export function MagneticText({
  ...
  const labelClass = cn(
    "whitespace-nowrap text-5xl font-bold tracking-tight",
    textClassName,
  );
  ...
  return (
    ...
    >
      <span className={cn(labelClass, "text-foreground")}>{text}</span>
      ...
      >
        ...
        >
          <span className={cn(labelClass, "text-background")}>{hoverText}</span>
        </div>
      </div>
    </div>
  );
