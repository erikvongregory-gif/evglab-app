...
const SUBPAGE_LINK_SIGNALS: Array<{ signal: string; weight: number }> = [
  ...
  { signal: "limonade", weight: 40 },
  { signal: "softdrink", weight: 32 },
  { signal: "erfrischungsgetraenk", weight: 32 },
  { signal: "brause", weight: 24 },
  { signal: "zitrone", weight: 20 },
  { signal: "orange", weight: 20 },
  { signal: "pils", weight: 20 },
  { signal: "helles", weight: 20 },
  { signal: "weizen", weight: 20 },
