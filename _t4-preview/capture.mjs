...
await shot("10-mobile-320.png", 320, 568, `${base}/design-handoff?screen=dashboard`);
await shot("11-kpi-charges-label.png", 1440, 900, `${base}/design-handoff?screen=dashboard`);
await shot("12-chart-tokens-per-day.png", 1440, 900, `${base}/design-handoff?screen=dashboard`);
