...
const baseUrl = process.env.NEXT_PUBLIC_APP_BASE_URL?.trim() || "(nicht gesetzt — Fallback im Code: https://app.evglab.com)";
...
if (baseUrl !== "(nicht gesetzt — Fallback im Code: https://app.evglab.com)") {
  try {
